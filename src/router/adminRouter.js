...
adminroutes.post("/listproductbyvendorid", listProductByVendorId);
adminroutes.post("/updateproduct", authenticateAdmin, updateProduct);
adminroutes.post("/updateTag", authenticateAdmin, updateTag);
